enum ActionTypes {
  ...
  SET_AUDIO_RECORDING = "track/SET_AUDIO_RECORDING",
  SET_AUDIO_RECORDING_TIME_START = "track/SET_AUDIO_RECORDING_TIME_START",
  SET_AUDIO_RECORDING_TIME_END = "track/SET_AUDIO_RECORDING_TIME_END",
